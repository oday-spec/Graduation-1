...
from oday.common.payloads import PAYLOADS
from oday.logger.colored_logger import logger
from oday.common.prettytable import PrettyTable, from_db_cursor
...
def fetch_payloads_by_suffix_prefix(
    ...
    if is_parameter_replace:
        ...
        # we will use the default payload base prefixes and suffixes if any from oday
        prefix = None
        suffix = None
